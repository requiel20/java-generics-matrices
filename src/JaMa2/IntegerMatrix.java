 ...
 *  
 *  <P>
 *  The BooleanMatrix class represent a matrix of integers
...
public class IntegerMatrix extends AbstractMatrix<Integer>{
	...
	private static final long serialVersionUID = 2434693836339048432L;
	 ...
	 */
	protected IntegerMatrix(int m, int n) {
		this.m = m;
		this.n = n;
		this.A = new double[m][n];
		for (int i = 0; i < m; i++) {
	...
	public Matrix<Integer> copy() {
		return (Matrix<Integer>) super.copy();
	}
	 ...
	 */
	@Override
	public Integer get(int i, int j) throws ElementOutOfBoundsMatrixException {
		try {
			return (int) A[i][j];
	...
	public Matrix<Integer> getMatrix (int i0, int i1, int j0, int j1) throws SubMatrixOutOfBoundsMatrixException {
		Matrix X = Matrices.newIntegerMatrix(i1-i0+1,j1-j0+1);
		double[][] B = X.getArray();
		try {
			for (int i = i0; i <= i1; i++) {
				for (int j = j0; j <= j1; j++) {
	...
	public Matrix<Integer> getMatrix (int[] r, int[] c) throws SubMatrixOutOfBoundsMatrixException {
		Matrix X = Matrices.newIntegerMatrix(r.length,c.length);
		double[][] B = X.getArray();
		try {
	...
	public Matrix<Integer> getMatrix (int[] r, int j0, int j1) throws SubMatrixOutOfBoundsMatrixException {
		Matrix X = Matrices.newIntegerMatrix(r.length,j1-j0+1);
		double[][] B = X.getArray();
		try {
			for (int i = 0; i < r.length; i++) {
				for (int j = j0; j <= j1; j++) {
	...
	public Matrix<Integer> getMatrix (int i0, int i1, int[] c) throws SubMatrixOutOfBoundsMatrixException {
		Matrix X = Matrices.newIntegerMatrix(i1-i0+1,c.length);
		double[][] B = X.getArray();
		try {
			for (int i = i0; i <= i1; i++) {
				for (int j = 0; j < c.length; j++) {
	 ...
	 */
	@Override
	public void set (int i, int j, Integer element) throws ElementOutOfBoundsMatrixException{
		try {
	...
	public void setMatrix (int i0, int i1, int j0, int j1, Matrix<Integer> M) throws SubMatrixOutOfBoundsMatrixException {
		try {
			for (int i = i0; i <= i1; i++) {
				for (int j = j0; j <= j1; j++) {
	...
	public void setMatrix (int[] r, int[] c, Matrix<Integer> M) throws SubMatrixOutOfBoundsMatrixException {
		try {
			for (int i = 0; i < r.length; i++) {
				for (int j = 0; j < c.length; j++) {
					A[i][j] = M.get(i,j);
	...
	public void setMatrix (int[] r, int j0, int j1, Matrix<Integer> M) throws SubMatrixOutOfBoundsMatrixException {
		try {
			for (int i = 0; i < r.length; i++) {
				for (int j = j0; j <= j1; j++) {
					A[i][j] = M.get(i,j-j0);
	...
	public void setMatrix (int i0, int i1, int[] c, Matrix<Integer> M) throws SubMatrixOutOfBoundsMatrixException {
		try {
			for (int i = i0; i <= i1; i++) {
				for (int j = 0; j < c.length; j++) {
					A[i][j] = M.get(i-i0,j);
	...
	public Matrix<Integer> transpose() {
		...
		return (Matrix<Integer>) super.transpose();
	}
